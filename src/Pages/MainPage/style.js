...
import Image1Jpg from "../../Assets/images/image1.jpg";
import Image2Jpg from "../../Assets/images/image2.jpg";
...
export const ProjectsMenuContainerTitle = styled.div`
  font-size: 16px;
  font-weight: 600;
  color: #ededed;
  text-align: center;
...
export const ProjectsMenuContainerUl = styled.ul`
  display: flex;
  justify-content: center;
  align-items: center;
  margin-top: 10px;
...
export const ProjectsMenuContainerLi = styled.li`
  font-size: 22px;
  font-weight: 500;
  color: #ededed;
  cursor: pointer;
